...
const CinesPlantilla = (cine) => `
  <div class="contenido-cine">
    ...
    <br/>
    <a href="#" class="btn-ver-cine" data-id="${cine.id}">
...
const renderCines = (cines) => {
    var html = `<h1>Nuestros Cines</h1>`;

    cines.forEach(cine => {
        html += CinesPlantilla(cine);
    });
...
//Películas
const PeliculasPlantilla = (pelicula) => `
<div class="contenido-pelicula">
	<div class="datos-pelicula">
        ...
        <div class="boton-pelicula"> 
            <a href="#" class="btn-ver-pelicula" data-id="${pelicula.id}">
...
const renderPeliculas = (peliculas) => {
    var html = `<h1>Cartelera</h1>`;

    peliculas.forEach(pelicula => {
        html += PeliculasPlantilla(pelicula);
    });
    return html;
}
...
//Cine
const renderCine = (cine) => {
    var html = `<h2>${cine.RazonSocial}</h2>
            <div class="cine-info">
...
export { renderCines, renderPeliculas, renderPelicula, renderCine };
